...
- the `j2e-pac4j` library (<em>groupId</em>: **org.pac4j**, *version*: **1.3.2**)
...
See the [release notes](https://github.com/pac4j/j2e-pac4j/wiki/Release-Notes). Learn more by browsing the [j2e-pac4j Javadoc](http://www.javadoc.io/doc/org.pac4j/j2e-pac4j/1.3.2) and the [pac4j Javadoc](http://www.pac4j.org/apidocs/pac4j/1.9.2/index.html).
...
The version 1.3.3-SNAPSHOT is under development.
