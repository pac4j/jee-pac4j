...
It's based on Java 11, JavaEE 8 and on the **[pac4j security engine](/pac4j/pac4j) v5**. It's available under the Apache 2 license.
...
### 1) [Add the required dependencies](/pac4j/jee-pac4j/wiki/Dependencies)

### 2) Define:

### - the [security configuration](/pac4j/jee-pac4j/wiki/Security-configuration)
### - the [callback configuration](/pac4j/jee-pac4j/wiki/Callback-configuration), only for web applications
### - the [logout configuration](/pac4j/jee-pac4j/wiki/Logout-configuration)

### 3) [Apply security](/pac4j/jee-pac4j/wiki/Apply-security)

### 4) [Get the authenticated user profiles](/pac4j/jee-pac4j/wiki/Get-the-authenticated-user-profiles)


## Demos

Two demo webapps: [jee-pac4j-demo](/pac4j/jee-pac4j-demo) (a simple JSP/servlets demo) and [jee-pac4j-cdi-demo](/pac4j/jee-pac4j-cdi-demo) (a more advanced demo using JSF and CDI) are available for tests and implements many authentication mechanisms: Facebook, Twitter, form, basic auth, CAS, SAML, OpenID Connect, JWT...
...
The [next version](/pac4j/jee-pac4j/wiki/Next-version) is under development.

See the [release notes](/pac4j/jee-pac4j/wiki/Release-Notes). Learn more by browsing the [pac4j documentation](https://www.javadoc.io/doc/org.pac4j/pac4j-core/5.0.0/index.html) and the [jee-pac4j Javadoc](http://www.javadoc.io/doc/org.pac4j/jee-pac4j/6.0.0).

See the [migration guide](/pac4j/jee-pac4j/wiki/Migration-guide) as well.
