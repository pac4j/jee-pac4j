...
- `excludePath` (optional): the regular expression (starting by ^ and ending by $) which defines the full path(s) excluded from the authentication / authorization process.
